...
## Bản cập nhật calo mục tiêu 15%

- Thêm khối nổi bật nhất trong phần **Tổng quan**.
- Tính calo còn phải đốt để đạt 15% mỡ theo trạng thái hiện tại.
- Quy đổi sang thời gian đi bộ dốc 15 với tốc độ 3,3 km/h bằng công thức ACSM.
- Service Worker cache: `in-and-out-pwa-2026-07-11-v8`.
